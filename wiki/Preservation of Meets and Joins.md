...
- For any monotone map, $f(a) \vee f(b) \leq f(a \vee b)$ and $f(a \wedge b) \leq f(a) \wedge f(b)$ automatically ([[7S Exercise 1.94]]); preservation is the reverse inequality.
