...
- [[Isomorphism|Isomorphisms]] are [[Bijection|bijections]]; [[Monomorphism|monos]] are [[Injection|injections]], [[Epimorphism|epis]] are [[Surjection|surjections]]. $|\mathbf{Set}(\underline{2}, \underline{3})| = 9$ ([[7S Exercise 3.25]]); $|\mathbf{Set}(B, C)| = |C|^{|B|}$ — the [[Exponential Object]] $C^B$.
