...
- $(1, \text{add}, \text{zero})$ is a commutative [[Monoid Object]] in $\mathbf{Mat}(R)$ and $(1, \text{copy}, \text{discard})$ a cocommutative comonoid (Examples 5.68, 5.70); the functor $U : \mathbf{Mat}(R) \to \mathbf{Set}$, $n \mapsto R^n$, is a [[Monoidal Functor]] carrying it to the additive monoid $(R, +, 0)$ ([[7S Chapter 5 Exercises#Exercise 5.69|7S Exercise 5.69]]).
