...
- In Eq. (7.37) the fibers are $\{a_1, a_2\}$ over $a$, $\{b_1, b_2, b_3\}$ over $b$, $\{c_1\}$ over $c$, $\varnothing$ over $d$, $\{e_1, e_2\}$ over $e$ ([[7S Chapter 7 Exercises#Exercise 7.38|7S Exercise 7.38]]).
