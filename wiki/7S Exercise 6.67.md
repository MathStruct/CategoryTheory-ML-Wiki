...
**Exercise 6.67.** Fill in the missing diagram in the proof of Proposition 6.66 (every [[Hypergraph Category]] is a [[Compact Closed Category]] with every object self-dual) using the Frobenius equations (6.51), their opposites, and (6.53).
