...
- $\underline{\mathbf{1}} \times \mathcal{C} \cong \mathcal{C}$; for preorders $P, Q$ the product category is the [[Product Preorder]] ([[7S Exercise 3.90]]).
