...
- A graph as a table: Arrow table with columns source, target; Vertex table with only IDs (Eq. 3.61 = Example 1.37). Even the schema of `easySchema` is a $\mathsf{Gr}$-instance ([[7S Exercise 3.62]]).
