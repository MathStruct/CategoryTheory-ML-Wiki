...
- Adding equations gives a [[Presentation of a Prop]]; $\mathrm{Free}(G) $ is the prop presented by $(G, \varnothing)$ up to the "subtle difference" between a set and its quotient by the trivial relation ([[7S Exercise 5.35]]).
