...
- Skeletal dagger $\mathbf{Cost}$-categories are extended [[Metric Space|metric spaces]]; skeletal dagger $\mathbf{Bool}$-categories are sets ([[7S Chapter 2 Exercises#Exercise 2.73|7S Exercise 2.73]], [[7S Chapter 1 Exercises#Exercise 1.73|7S Exercise 1.73]]).
