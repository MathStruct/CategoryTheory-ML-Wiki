...
- Rose trees are `FreeMonad []`, non-empty binary trees `FreeMonad Bin` ([[DaoFP Chapter 14 Exercises#Exercise 14.8.1|DaoFP Exercise 14.8.1]], [[DaoFP Chapter 14 Exercises#Exercise 14.8.2|DaoFP Exercise 14.8.2]]); the [[List Monad]] is *not* free (its join is irreversible).
